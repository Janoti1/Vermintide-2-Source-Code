...
LevelEndViewBase.input_service = function (self)
	return not (not self:displaying_reward_presentation() and table.is_empty(self._transition_animations)) and FAKE_INPUT_SERVICE or self.input_manager:get_service("end_of_level")
end
