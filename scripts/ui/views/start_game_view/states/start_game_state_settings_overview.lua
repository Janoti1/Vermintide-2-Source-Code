...
StartGameStateSettingsOverview._initial_windows_setups = function (self, params)
	...
	start_layout_name = Managers.twitch and not (not Managers.twitch:is_connecting() and not Managers.twitch:is_connected()) and (Managers.mechanism:current_mechanism_name() == "deus" and "deus_twitch" or "twitch") or params.start_state or self:_start_layout_name()
