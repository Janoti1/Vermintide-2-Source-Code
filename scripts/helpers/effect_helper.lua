...
EffectHelper.vs_play_hit_sound = function (world, victim_unit, attack_type, damage_type, damage_source_name)
	...
	enemy_hit_sound = not (not burning_damage_types[damage_type] and (damage_type ~= "grenade" or damage_source_name ~= "grenade_fire_01")) and "fire" or projectile_attack_types[attack_type] and "bullet" or damage_type == "gas" and "gas" or "sword"
