local Credits = {
	...
	entries = {
		...
		{
			text = "Micha\xC5\x82 Zieli\xC5\x84ski",
			type = "person"
		},
		{
			text = " ",
		...
		{
			text = "Marina L\xC3\xA1zaro L\xC3\xB3pez",
			type = "person"
		},
		{
			text = " ",
		...
		{
			text = "Olof J\xC3\xB6nsson (Marauders, Skaven, Warpfire Thrower",
			type = "person"
		},
		{
